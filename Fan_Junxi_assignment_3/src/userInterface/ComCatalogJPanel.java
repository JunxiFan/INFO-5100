 ...
 * @author fjx19
 */
public class ComCatalogJPanel extends javax.swing.JPanel {
    ...
    ComCatalogJPanel(JPanel userProcessContainer, ProductDirectory productDirectory) {
         initComponents();
...
//            catalog = productDirectory.getCatalog();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Compouter Catalog");
    ...
    private void createBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createBtnActionPerformed
        // TODO add your handling code here:
        ComCreateJPanel panel = new ComCreateJPanel(userProcessContainer, productDirectory);
        userProcessContainer.add("ComCreateJPanel", panel);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
    ...
    private void detailsBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_detailsBtnActionPerformed
        ...
        if(selectedrow >= 0){
            if(vendorID.equals(vendor)){
                Product product = (Product) CatalogTbl.getValueAt(selectedrow, 0);
                ComViewJPanel panel = new ComViewJPanel(userProcessContainer, product);
                userProcessContainer.add("ComViewJPanel", panel);
                CardLayout layout = (CardLayout) userProcessContainer.getLayout();
                layout.next(userProcessContainer);
            }
            else
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        ...
        if(result==null){
            ...
            ComViewJPanel panel = new ComViewJPanel(userProcessContainer, result);
