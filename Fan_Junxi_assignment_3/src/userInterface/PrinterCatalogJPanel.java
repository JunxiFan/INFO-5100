 ...
 * @author fjx19
 */
public class PrinterCatalogJPanel extends javax.swing.JPanel {
    ...
    PrinterCatalogJPanel(JPanel userProcessContainer, ProductDirectory productDirectory) {
         initComponents();
...
//            catalog = productDirectory.getCatalog();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Printer Catalog");
    ...
    private void createBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createBtnActionPerformed
        // TODO add your handling code here:
        PrinterCreateJPanel panel = new PrinterCreateJPanel(userProcessContainer, productDirectory);
        userProcessContainer.add("PrinterCreateJPanel", panel);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
    ...
    private void detailsBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_detailsBtnActionPerformed
        ...
        if(selectedrow >= 0){
            if(vendorID.equals(vendor)){
                Product product = (Product) CatalogTbl.getValueAt(selectedrow, 0);
                PrinterViewJPanel panel = new PrinterViewJPanel(userProcessContainer, product);
                userProcessContainer.add("PrinterViewJPanel", panel);
                CardLayout layout = (CardLayout) userProcessContainer.getLayout();
                layout.next(userProcessContainer);
            }
            else
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        ...
        if(result==null){
            ...
            PrinterViewJPanel panel = new PrinterViewJPanel(userProcessContainer, result);
