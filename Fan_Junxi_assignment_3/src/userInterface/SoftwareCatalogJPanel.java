 ...
 * @author fjx19
 */
public class SoftwareCatalogJPanel extends javax.swing.JPanel {
    ...
    SoftwareCatalogJPanel(JPanel userProcessContainer, ProductDirectory productDirectory) {
         initComponents();
...
//            catalog = productDirectory.getCatalog();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Software Products Catalog");
    ...
    private void createBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createBtnActionPerformed
        // TODO add your handling code here:
        SoftwareCreateJPanel panel = new SoftwareCreateJPanel(userProcessContainer, productDirectory);
        userProcessContainer.add("SoftwareCreateJPanel", panel);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
    ...
    private void detailsBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_detailsBtnActionPerformed
        ...
        if(selectedrow >= 0){
            if(vendorID.equals(vendor)){
                Product product = (Product) CatalogTbl.getValueAt(selectedrow, 0);
                SoftwareViewJPanel panel = new SoftwareViewJPanel(userProcessContainer, product);
                userProcessContainer.add("SoftwareViewJPanel", panel);
                CardLayout layout = (CardLayout) userProcessContainer.getLayout();
                layout.next(userProcessContainer);
            }
            else
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        ...
        if(result==null){
            ...
            SoftwareViewJPanel panel = new SoftwareViewJPanel(userProcessContainer, result);
